...
//Steering Variables:
#define MV_servoMin 990
#define MV_servoMax 1490
...
//Joystick Deadzone (prevents drift from minor joystick noise)
#define MV_JOYSTICK_DEADZONE 2   // Ignore joystick values within ±2 of center

//Winch Control
#define MV_WINCH_SPEED_FACTOR 0.8  // Multiply winch button pressure by this value (0.0-1.0)
